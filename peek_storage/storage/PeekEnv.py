...
class PeekEnvServer(Tuple, DeclarativeBase):
    ...
    """
    __tupleType__ = 'peek_storage.env.server'
...
class PeekEnvWorker(Tuple, DeclarativeBase):
    ...
    """
    __tupleType__ = 'peek_storage.env.worker'
    ...
    serverId = Column(ForeignKey('peek_storage.PeekEnvServer.id'), primary_key=True)
...
class PeekEnvAgent(Tuple, DeclarativeBase):
    ...
    """
    __tupleType__ = 'peek_storage.env.agent'
...
class PeekEnvClient(Tuple, DeclarativeBase):
    ...
    """
    __tupleType__ = 'peek_storage.env.client'

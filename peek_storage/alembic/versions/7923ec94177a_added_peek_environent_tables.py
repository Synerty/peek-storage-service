...
def upgrade():
    ...
    sa.ForeignKeyConstraint(['serverId'], ['peek_storage.PeekEnvServer.id'], ),
...
def downgrade():
    ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('PeekEnvWorker', schema='peek_storage')
    op.drop_table('PeekEnvClient', schema='peek_storage')
    op.drop_table('PeekEnvAgent', schema='peek_storage')
    op.drop_table('PeekEnvServer', schema='peek_storage')
    ### end Alembic commands ###
